    ...
    <v-card elevation="0" outlined rounded="lg">
      <v-card-text>
        <v-row>
          ...
          >
          <v-col cols="col">
            <div class="text-h5 font-weight-bold">Place a liquidity position on Kyberswap</div>
            <div class="mt-2">
              Place a liquidity position on Kyberswap<span v-if="data.pairsName">
                with pairs {{ data.pairsName }}
              </span>
...
@Component
export default class KyberLiquidity extends Vue {
