    ...
    <v-card elevation="0" outlined rounded="lg">
      <v-card-text>
        <v-row>
          ...
          >
          <v-col cols="col">
            <div class="text-h5 font-weight-bold">Bridge on Kyberswap</div>
            <div class="mt-2">Bridge on Kyberswap to complete this task</div></v-col
          >
...
@Component
export default class KyberBridge extends Vue {
