<template>
  <v-sheet class="overflow-hidden rounded-lg" elevation="3">
    <v-sheet class="position-relative">
      <v-img height="350" src="https://diversity-api.contracts.dev/uploads/Component_10_8ff4d44977.png"></v-img>
      <v-sheet class="d-flex justify-end countdown-container transparent pa-6">
        <v-sheet class="transparent rounded-lg" width="60%">
          <countdown>
      ...
      <v-sheet class="title-container d-flex align-center px-5 py-3">
        ...
        <v-sheet class="transparent title blue--text px-6">The Peaky Blinder</v-sheet>
      </v-sheet>
    </v-sheet>
    <v-sheet class="d-flex px-6 py-4">
      <v-sheet class="d-flex flex-column">
        <v-sheet class="text-1 neutral10--text">Total reward</v-sheet>
        <v-sheet class="text-2 mt-1">1000 TVN</v-sheet>
      </v-sheet>
      <v-sheet class="d-flex flex-column ml-9">
        <v-sheet class="text-1 neutral10--text">Participants</v-sheet>
        <v-sheet class="text-2 mt-1">1000</v-sheet>
      </v-sheet>
    </v-sheet>
    <v-sheet class="px-6 pb-6">
      <v-btn class="btn btn-text text-capitalize white--text rounded-lg" width="100%" x-large>
